...
launch from the command line:
    ...
    $ lein run -m trello-url-service.web
...
get the app created:
    ...
    $ heroku apps:create trello-url-service
    Creating trello-url-service... done, stack is cedar
    http://trello-url-service.herokuapp.com/ | git@heroku.com:trello-url-service.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://trello-url-service.herokuapp.com deployed to Heroku

    To git@heroku.com:trello-url-service.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://trello-url-service.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@trello-url-service.herokuapp.com/repl
